                        ...
                        <?php
                         if ($fetch_data->num_rows() > 0) {
                             foreach ($fetch_data->result() as $d) {
                                echo "<h5><b style='color:red;'>$d->date_diff days</b> left until your plan expires. Go to <b>Sidebar->CURRENT PLAN</b> and Extend Plan!</h5>";
                            }
                        }
                        else{
                            echo "No new messages from Admin.";
                        }
                        ?>  
                </div>      
        </div>
