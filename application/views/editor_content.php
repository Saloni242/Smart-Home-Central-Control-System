...
.pointer {cursor: pointer;}
 ...
 <form role="form" method="post" id="register_form" action="<?php echo base_url('admin/editoraddcontent'); ?>" enctype=multipart/form-data>
<div class="showscroll">
    ...
    <br/>
    <br/>
    <p style="margin-left: 135px">Enter Text:</p>
