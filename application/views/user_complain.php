                ...
                <div class="w3-container w3-padding-64 w3-theme-l5" id="contact">
                    <div class="w3-row">
                        <div class="w3-col m5">
                            ...
                            <p><i class="fas fa-map-marker-alt" style="color:#009688; font-size:23px;"></i>&nbsp;&nbsp;&nbsp;A-705, Titanium City Center,  
                            Ahmedabad, Gujarat. 
                            </p>
                            <p><i class="fas fa-phone" style="color:#009688; font-size:23px;"></i>&nbsp;&nbsp;+91 9426634597</p>
                            <p><i class="fas fa-envelope" style="color:#009688; font-size:23px;"></i>&nbsp;&nbsp;saloni.goyal242@gmail.com</p>
                        </div>
                        <div class="w3-col m7">
                            <?php
                            if ($fetch_data->num_rows() > 0) {
                                foreach ($fetch_data->result() as $u) {
                                    ...
                                    <form class="w3-container w3-card-4 w3-padding-16 w3-white" action="<?php echo base_url('userpanel/user_complain/' . $u->name) ?>"  method="post">
                                        <center>
                                        <?php
                                                  $email_msg=$this->session->flashdata('email_sent');
                                                  if($email_msg){
                                                    echo "<div style='font-weight:bold;'>$email_msg</div>";
                                                  }
