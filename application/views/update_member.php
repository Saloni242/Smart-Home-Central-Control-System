              ...
              <div class="login-panel panel panel-success">
                  ...
                  else
                  {
                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('admin/reset_update_member');?>" id="register_form" enctype=multipart/form-data>
                         ...
                         <?php echo form_open('form'); ?> 
                          ...
                          <fieldset>
                            <div class="form-group">
                                  ID:
                                  <input class="form-control" placeholder="member id" name="member_id" type="number" id="member_id" autofocus value="<?php echo $records['member_id']; ?>" readonly style="cursor: no-drop;">
                              </div>

                              <div class="form-group">
                                Name:
                                  <input class="form-control" placeholder="Name" name="member_name" type="text" id="member_name" autofocus value="<?php echo $records['name']; ?>">
                              </div>

                              <div class="form-group">
                                  Upload Picture:<input type="file" name="file" value="<?php echo base_url(); ?>assets/team/<?php echo $records['member_image'];?>" id="fileUpload" onchange="readURL(this);">
                              </div>
                              <img alt="Image Display Here" id="test" src="#"  width="300" height="200" />

                              <div class="form-group">
                                Designation:
                                  <input class="form-control" placeholder="Designation" name="designation" id="designation" value="<?php echo $records['designation'];?>">
                              </div>

                              <div class="form-group">
                                Field:
                                  <input class="form-control" placeholder="Field" name="field"  id="field" value="<?php echo $records['field'];?>">
                              </div>

                              <div class="form-group">
                                About:
                                  <input class="form-control" placeholder="About" name="member_about" id="member_about" value="<?php echo $records['member_about'];?>">
                              </div>

                              <div class="form-group">
                                E-mail:
                                  <input class="form-control" placeholder="E-mail" name="member_email" type="email" id="member_email" autofocus value="<?php echo $records['member_email'];?>">
                              </div>
