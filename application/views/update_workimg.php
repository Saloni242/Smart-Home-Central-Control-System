              ...
              <div class="login-panel panel panel-success">
                  ...
                  else
                  {
                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('admin/reset_update_workimg');?>" id="register_form" enctype=multipart/form-data>
                         ...
                         <?php echo form_open('form'); ?> 
                          ...
                          <fieldset>
                            <div class="form-group">
                                  ID:
                                  <input class="form-control" placeholder="Image id" name="img_id" type="number" id="img_id" autofocus value="<?php echo $records['img_id']; ?>" readonly style="cursor: no-drop;">
                            </div>

                              <div class="form-group">
                                Caption:
                                  <input class="form-control" placeholder="Caption" name="caption" type="text" id="caption" autofocus value="<?php echo $records['caption']; ?>">
                              </div>

                              <div class="form-group">
                                  Upload Picture:<input type="file" name="file" value="<?php echo base_url(); ?>assets/work/<?php echo $records['work_img'];?>" id="fileUpload" onchange="readURL(this);">
                              </div>
