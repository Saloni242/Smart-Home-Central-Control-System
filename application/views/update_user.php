              ...
              <div class="login-panel panel panel-success">
                  ...
                  else
                  {
                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('admin/reset_update_user');?>" id="register_form" enctype=multipart/form-data>
                         ...
                         <?php echo form_open('form'); ?> 
                          ...
                          <fieldset>
                            <div class="form-group">
                                  ID:
                                  <input class="form-control" placeholder="User id" name="user_id" type="number" id="user_id" autofocus value="<?php echo $records['user_id']; ?>" readonly style="cursor: no-drop;">
                              </div>

                              <div class="form-group">
                                Name:
                                  <input class="form-control" placeholder="Name" name="user_name" type="text" id="user_name" autofocus value="<?php echo $records['user_name']; ?>">
                              </div>

                              <div class="form-group">
                                E-mail:
                                  <input class="form-control" placeholder="E-mail" name="user_email" type="email" id="user_email" autofocus value="<?php echo $records['user_email'];?>">
                              </div>
                              <div class="form-group">
                                Password:
                                  <input class="form-control" placeholder="Password" name="user_password" type="password" id="user_password" value="<?php echo $records['user_password'];?>">
                              </div>

                              <div class="form-group">
                                Age:
                                  <input class="form-control" placeholder="Age" name="user_age" type="number" id="user_age" value="<?php echo $records['user_age'];?>">
                              </div>

                              <div class="form-group">
                                Mobile Number:
                                  <input class="form-control" placeholder="Mobile No" name="user_mobile" type="number" id="user_mobile" value="<?php echo $records['user_mobile'];?>">
                              </div>

                               <div class="form-group">
                                Select Country:
                                <select id="countries_states1" class=" form-control input-medium bfh-countries" data-country="<?php echo $records['user_country'];?>" name="user_country"></select>
                              </div>

                              <div class="form-group">
                                State:
                                <select class="form-control input-medium bfh-states" data-country="countries_states1" data-state="<?php echo $records['user_state'];?>" name="user_state"></select>
                              </div>


                              <div class="form-group">
                                Status
                                  <input class="form-control" placeholder="Status" name="user_status" type="number" id="user_status" value="<?php echo $records['status'];?>">
                              </div>

                              <div class="form-group">
                                  Upload profile Picture:<input type="file" name="file" value="<?php echo base_url(); ?>assets/thumbnails/<?php echo $records['user_picture'];?>" id="fileUpload" onchange="readURL(this);">
                              </div>
...
<script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/updateitional-methods.min.js"></script>
