              ...
              <div class="login-panel panel panel-success">
                  ...
                  else
                  {
                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('admin/reset_add_plan'); ?>" id="update_plan_form">
                         <?php echo validation_errors(); ?>  
                         <?php echo form_open('form'); ?> 
                          <fieldset>
                              <div class="form-group">
                                  <input class="form-control" placeholder="Plan ID" name="plan_id" type="text" id="plan_id" autofocus required="true">
                              </div>

                              <div class="form-group">
                                  <input class="form-control" placeholder="Title" name="plan_title" type="text" id="plan_title" autofocus required="true">
                              </div>
                              <div class="form-group">
                                  <input class="form-control" placeholder="Description" name="plan_desc" type="text" value="" id="plan_desc" required="true">
                              </div>

                              <div class="form-group">
                                  <input class="form-control" placeholder="Month" name="plan_month" type="number" value="" id="plan_month" required="true">
                              </div>

                              <div class="form-group">
                                  <input class="form-control" placeholder="Price" name="plan_price" type="number" value="" id="plan_price" required="true">
                              </div>

                              <div class="form-group">
                                  <input class="form-control" placeholder="Device_count" name="plan_device" type="number" value="" id="plan_device" required="true">
                              </div>
