...
.pointer {cursor: pointer;}
 ...
 <form role="form" method="post" id="register_form" action="<?php echo base_url('admin/editoraddbanner'); ?>" enctype=multipart/form-data>
<div class="showscroll">
    <h3 style="margin-left: 135px">Manage Banner</h3>
    <p style="margin-left: 135px">Enter Title:</p>
    <textarea  id="title" required="true" rows="1" cols="100" name="title"></textarea>
    <br/>
    <br/>
    <p style="margin-left: 135px">Enter Button Content:</p>
    <textarea  id="button" required="true" rows="1" cols="100" name="button"></textarea>
    <br/>
    <br/>
    <p style="margin-left: 135px">Upload Banner Image:</p>
