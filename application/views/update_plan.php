          ...
          <div class="col-md-4 col-md-offset-4"><!--col-md-4 is used to create the no of colums in the grid also use for medimum and large devices-->
              <div class="login-panel panel panel-success">
                  ...
                  <div class="panel-body">
                      ...
                      <form role="form" method="post" action="<?php echo base_url('admin/reset_update_plan'); ?>" id="update_plan_form">
                         ...
                         <?php echo form_open('form'); ?> 
                          <fieldset>
                              ...
                              <div class="form-group">
                                ID:
                                  <input class="form-control" placeholder="Plan ID" name="plan_id" type="text" id="plan_id" autofocus required="true" value="<?php echo $records['plan_id']; ?>   "  readonly style="cursor: no-drop;">
                              </div>

                              <div class="form-group">
                                Title:
                                  <input class="form-control" placeholder="Title" name="plan_title" type="text" id="plan_title" autofocus required="true"  value="<?php echo $records['Title']; ?>  ">
                              </div>
                              <div class="form-group">
                                Description:
                                  <input class="form-control" placeholder="Description" name="plan_desc" type="text" id="plan_desc" required="true"  value="<?php echo $records['Description']; ?> ">
                              </div>

                              <div class="form-group">
                                Month:
                                  <input class="form-control" placeholder="Month" name="plan_month" type="number" id="plan_month" required="true" value="<?php echo $records['Month']; ?>">
                              </div>

                              <div class="form-group">
                                Price:
                                  <input class="form-control" placeholder="Price" name="plan_price" type="number" id="plan_price" required="true"  value="<?php echo $records['Price']; ?>">
                              </div>

                              <div class="form-group">
                                Device Count:
                                  <input class="form-control" placeholder="Device_count" name="plan_device" type="number"  id="plan_device" required="true" value="<?php echo $records['Device_count']; ?>">
                              </div>
